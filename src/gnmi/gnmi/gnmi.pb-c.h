...
/* Generated from: gnmi/gnmi.proto */

#ifndef PROTOBUF_C_gnmi_2fgnmi_2eproto__INCLUDED
#define PROTOBUF_C_gnmi_2fgnmi_2eproto__INCLUDED
...
typedef struct Gnmi__TypedValue Gnmi__TypedValue;
typedef struct Gnmi__Path Gnmi__Path;
typedef struct Gnmi__PathElem Gnmi__PathElem;
typedef struct Gnmi__PathElem__KeyEntry Gnmi__PathElem__KeyEntry;
typedef struct Gnmi__Value Gnmi__Value;
typedef struct Gnmi__Error Gnmi__Error;
typedef struct Gnmi__Decimal64 Gnmi__Decimal64;
typedef struct Gnmi__ScalarArray Gnmi__ScalarArray;
typedef struct Gnmi__SubscribeRequest Gnmi__SubscribeRequest;
typedef struct Gnmi__Poll Gnmi__Poll;
typedef struct Gnmi__SubscribeResponse Gnmi__SubscribeResponse;
typedef struct Gnmi__SubscriptionList Gnmi__SubscriptionList;
typedef struct Gnmi__Subscription Gnmi__Subscription;
typedef struct Gnmi__QOSMarking Gnmi__QOSMarking;
typedef struct Gnmi__SetRequest Gnmi__SetRequest;
typedef struct Gnmi__SetResponse Gnmi__SetResponse;
typedef struct Gnmi__UpdateResult Gnmi__UpdateResult;
typedef struct Gnmi__GetRequest Gnmi__GetRequest;
typedef struct Gnmi__GetResponse Gnmi__GetResponse;
typedef struct Gnmi__CapabilityRequest Gnmi__CapabilityRequest;
typedef struct Gnmi__CapabilityResponse Gnmi__CapabilityResponse;
typedef struct Gnmi__ModelData Gnmi__ModelData;
...
typedef enum _Gnmi__UpdateResult__Operation {
   ...
   */
  GNMI__UPDATE_RESULT__OPERATION__UNION_REPLACE = 4
...
typedef enum {
  ...
  GNMI__TYPED_VALUE__VALUE_DOUBLE_VAL = 14,
  ...
  GNMI__TYPED_VALUE__VALUE_PROTO_BYTES = 13
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GNMI__TYPED_VALUE__VALUE__CASE)
...
struct  Gnmi__TypedValue
{
  ...
  union {
     ...
     */
    float float_val PROTOBUF_C__DEPRECATED;
    /*
     ...
     * Deprecated - use double_val.
     */
    Gnmi__Decimal64 *decimal_val PROTOBUF_C__DEPRECATED;
    /*
...
struct  Gnmi__PathElem__KeyEntry
{
  ProtobufCMessage base;
  char *key;
  char *value;
...
typedef enum {
  ...
  GNMI__SUBSCRIBE_REQUEST__REQUEST_POLL = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GNMI__SUBSCRIBE_REQUEST__REQUEST__CASE)
...
typedef enum {
  ...
  GNMI__SUBSCRIBE_RESPONSE__RESPONSE_ERROR = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GNMI__SUBSCRIBE_RESPONSE__RESPONSE__CASE)
 ...
 */
struct  Gnmi__SubscribeResponse
{
  ProtobufCMessage base;
  /*
...
#define GNMI__SUBSCRIPTION_LIST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&gnmi__subscription_list__descriptor) \
    , NULL, 0,NULL, NULL, GNMI__SUBSCRIPTION_LIST__MODE__STREAM, 0, 0,NULL, GNMI__ENCODING__JSON, 0 }
...
struct  Gnmi__SetRequest
{
   ...
   * for details.
   */
  size_t n_union_replace;
  Gnmi__Update **union_replace;
  /*
 ...
 */
struct  Gnmi__CapabilityRequest
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  Gnmi__CapabilityResponse
{
  ProtobufCMessage base;
  /*
...
typedef struct Gnmi__GNMI_Service Gnmi__GNMI_Service;
struct Gnmi__GNMI_Service
{
...
#endif  /* PROTOBUF_C_gnmi_2fgnmi_2eproto__INCLUDED */
